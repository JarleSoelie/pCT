...
int main(int argc, char *argv[]){
  ...
  float d_phantom = 150.0; //*** mm between inner tracker and phantom edge. This is used to reduce the hull calculation time at later steps. = 125.0mm for CTP phantoms due to smaller radius!
  ...
  /*//Prepare for hull (CTP-phantoms) (comment out the one not applicable)
  TFile* phantomFile = new TFile("cylinderLP.root","update"); //Load your 3D representation of the phantom!
  TH3S* hull = new TH3S("hull", "Hounsfield Units", 321,-80.25,80.25, 321,-80.25,80.25, 101,-25.25,25.25);
  phantomFile->GetObject("cylinderPhantom",hull); 
  //*/
...
//--------------------------------------------------  
 //Prepare the hull map. Must overlap with the original simulation phantom coordinates and have room for hull finding
 //Comment or uncomment for head or CTP phantom
 //---------CTP phantom hull map----------- 
 /*
